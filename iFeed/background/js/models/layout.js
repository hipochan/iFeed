            ...
            function Layout() {
                ...
                this.load = function () {
                    _this.getData('layout', function (result) {
                        ...
                        _this.save(function () {
                            return iFeed.messenger.sendRequest(0 /* backend */, 'LayoutLoaded');
                        });
                    });
                };
                ...
                this.addFeedContent = function (feedId) {
                    ...
                    _this.save(function () {
                        return iFeed.messenger.sendResponse(1 /* frontend */, 'GetLayoutResponsse', true, '', iFeed.layout.LayoutData);
                    });
                };
